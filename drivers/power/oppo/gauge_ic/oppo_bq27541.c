...
{
	pr_err("%s:ouyang gauge_ic->bq27541_i2c_error = %d\n", __func__,gauge_ic->bq27541_i2c_error);
...
//OuYangBaiLi@BSP.CHG.Basic 2018/12/21 modify for vooc charge and normal charge compatibility
		...
		if(gauge_ic->bq27541_i2c_error&&(pcb_version < 4)){
			chg_debug(" bq27541_read_i2c error\n");
			chg_debug(" failed\n");
			return -ENOMEM;
		}else{
...
subsys_initcall(bq27541_i2c_init);
static void __exit bq27541_i2c_exit(void)
{
	i2c_del_driver(&bq27541_i2c_driver);
}
