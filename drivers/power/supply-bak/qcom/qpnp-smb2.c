...
#ifdef CONFIG_VENDOR_REALME//Fanhong.Kong@ProDrv.CHG,add 2018/06/02 for SVOOC OTG
...
#ifdef CONFIG_VENDOR_REALME//Fanhong.Kong@ProDrv.CHG,add 2018/04/20 for SVOOC
